...
namespace RVP
{
    ...
    public class FollowAI : MonoBehaviour
    {
        ...
        void FixedUpdate() {
            if (target) {
                ...
                if (targetIsWaypoint) {
                    ...
                    if ((tr.position - target.position).sqrMagnitude <= targetWaypoint.radius * targetWaypoint.radius && targetWaypoint.nextPoint != null) {
                ...
                if (ForcedStop)
                {
                    vp.SetAccel(0.9f * vp.accelInput + 1);
                    vp.SetBrake(prevSpeed/speed);
                    stoppedTime = 0;
                }
        ...
        public void hasToStop(bool input)
        {
            ForcedStop = input;
        }
